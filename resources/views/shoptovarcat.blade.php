...
<div class="shop_page_holder" >
	...
	<form role="search" method="get" class="searchformShop" action="http://paleo-cafe.com.au/">
		<div>
			<input type="text" class="search_title_shop" id="search_title_shop" placeholder="Пошук" value="" name="s">
			...
			<div class="price_slider_wrapper">
				...
				<div class="price_slider_amount">
					...
					<div class="price_label" style="">
						Ціна: <span class="from">7</span> — <span class="to">25</span>
					</div>
